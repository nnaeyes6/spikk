...
class CreatingAccount extends StatefulWidget {
  ...
  CreatingAccount({required this.password, required this.reEnterPassword});

  @override
  State<CreatingAccount> createState() => _CreatingAccount();
}

class _CreatingAccount extends State<CreatingAccount> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SlidingUpPanel(
          ...
          panelBuilder: (controller) => CreatingAccountPanel(
