...
class GuestEnableLocation extends StatefulWidget {
  final String password;
  final String reEnterPassword;
  GuestEnableLocation({required this.password, required this.reEnterPassword});

  @override
  State<GuestEnableLocation> createState() => _GuestEnableLocationState();
}

class _GuestEnableLocationState extends State<GuestEnableLocation> {
