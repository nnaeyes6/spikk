...
import 'package:spik_app/widgets/sliding_up_panel/sliding_up_panel_guideline.dart';

class Guidelines extends StatefulWidget {
  final String password;
  final String reEnterPassword;
  Guidelines({required this.password, required this.reEnterPassword});

  @override
  State<Guidelines> createState() => _PickerEnableLocationState();
}

class _PickerEnableLocationState extends State<Guidelines> {
  bool isChecked = false;
  bool _showPassword = false;
  bool _obscureText = true;
  @override
  Widget build(BuildContext context) {
    double panelOpen = 610;
    ...
    return Scaffold(
      ...
      body: SlidingUpPanel(
        ...
        panelBuilder: (controller) => SlidingUpPanelGuideline(
