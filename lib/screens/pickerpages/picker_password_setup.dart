...
import 'package:spik_app/screens/pickerpages/picker_enable_location.dart';
import 'package:spik_app/widgets/color.dart';

class PickerPasswordSetUp extends StatefulWidget {
  @override
  State<PickerPasswordSetUp> createState() => _PickerPasswordSetUpState();
}

class _PickerPasswordSetUpState extends State<PickerPasswordSetUp> {
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              ...
                              filled: true,
                              fillColor: AppColor.insideContaiinerBackground,
                            ...
                            Container(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  // AuthFormValidation.instance.trySubmit();
