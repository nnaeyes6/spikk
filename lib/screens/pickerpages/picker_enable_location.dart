...
import 'package:spik_app/widgets/sliding_up_panel_location.dart';

class PickerEnableLocation extends StatefulWidget {
  final String password;
  final String reEnterPassword;
  PickerEnableLocation({required this.password, required this.reEnterPassword});

  @override
  State<PickerEnableLocation> createState() => _PickerEnableLocationState();
}

class _PickerEnableLocationState extends State<PickerEnableLocation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SlidingUpPanel(
        ...
        panelBuilder: (controller) => SlidingUpPanelLocation(
